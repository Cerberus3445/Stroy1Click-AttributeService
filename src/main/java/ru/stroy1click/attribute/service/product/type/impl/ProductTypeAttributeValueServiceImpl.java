...
public class ProductTypeAttributeValueServiceImpl implements ProductTypeAttributeValueService {
    ...
    public void create(ProductTypeAttributeValueDto productTypeAttributeValueDto) {
        ...
        this.productTypeClient.get(productTypeAttributeValueDto.getProductTypeId());
    ...
    public void delete(Integer id) {
        ...
        this.cacheClear.clearAllProductTypeAttributeValuesByProductTypeId(productTypeAttributeValue.getProductTypeId());
